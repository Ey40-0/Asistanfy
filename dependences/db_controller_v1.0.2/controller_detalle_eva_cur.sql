...
--
-- Table structure for table `detalle_eva_cur`
--

DROP TABLE IF EXISTS `detalle_eva_cur`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `detalle_eva_cur` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_cur` int NOT NULL,
  `id_eva` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `Detalle_eva_cur_Cur_FK` (`id_cur`),
...
--
-- Dumping data for table `detalle_eva_cur`
--
